...
let maxDep = 6; // 比较的最大深度

/**
 * [type utils]
 * @type {Array}
 */
let jsType = ["Boolean", "Number", "String", "Function", "Array", "Date", "RegExp", "Object", "Error"];
let dUtil = {};
...
function deepCompare(instance, nextProps, nextState) {
    let result = !deepEqual(instance.props, nextProps, 1) || !deepEqual(instance.state, nextState, 1);
    return result;
}
