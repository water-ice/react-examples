...
class PullScroll extends Component {
	constructor(props,context) {
		...
		this.handlePullStatusChange = this.handlePullStatusChange.bind(this);
		this.handlePulling = this.handlePulling.bind(this);
	}
	// PullScroll状态变更逻辑
	...
	render() {
		...
		const {className,isEnd,style,wrapper,height,pull,scroll} = this.props;
		return (
			<div 
				className={
					classnames(
			...
			>
				...
				<MainView 
					...
					ref = "main"
				/>
				<Dropload status={isEnd} show={scroll}/>
			</div>
		);
	}
}
