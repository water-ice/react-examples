...
我们使用 [`GitHub Issues`](https://github.com/deot/react-examples/issues) 来做 `bug` 追踪。

在你报告一个 `bug` 之前，请先确保已经搜索过已有的 `issue` 和阅读了我们的 [常见问题](https://github.com/deot/react-examples/wiki/FAQ)。
