...
const webpackConfig = {
	resolve: {//重定向路径
		...
		alias: {
			...
			// 主端
			'@img/home'						: resetPath('home/img'),
			'@actions/home'					: resetPath('home/pages/actions'),
			'@components/home'				: resetPath('home/pages/components'),
			'@constants/home'				: resetPath('home/pages/constants'),
			'@utils/home'					: resetPath('home/pages/utils'),
			// 代理端
			'@img/agent'					: resetPath('agent/img'),
			'@actions/agent'				: resetPath('agent/pages/actions'),
			'@components/agent'				: resetPath('agent/pages/components'),
			'@constants/agent'				: resetPath('agent/pages/constants'),
			'@utils/agent'					: resetPath('agent/pages/utils'),
			// 零售端
			'@img/shop'						: resetPath('shop/img'),
			'@actions/shop'					: resetPath('shop/pages/actions'),
			'@components/shop'				: resetPath('shop/pages/components'),
			'@constants/shop'				: resetPath('shop/pages/constants'),
			'@utils/shop'					: resetPath('shop/pages/utils'),
		}
	},
	entry: {
